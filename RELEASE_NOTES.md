## LightSports v1.12 — The shake asks instead of interrupting
...
Issue titles now follow the same convention as every other app — `LightSports v1.12.x — <headline>`,
labelled `sports` — instead of the `sports: <headline>` this app had invented.

### Reporting is a library now

The eight files under `com.gios.lightsports.report` are gone. They are
